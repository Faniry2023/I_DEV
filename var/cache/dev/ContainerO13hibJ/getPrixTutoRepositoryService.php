 ...
 */
class getPrixTutoRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PrixTutoRepository' shared autowired service.
     *
     * @return \App\Repository\PrixTutoRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PrixTutoRepository.php';

        return $container->privates['App\\Repository\\PrixTutoRepository'] = new \App\Repository\PrixTutoRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
