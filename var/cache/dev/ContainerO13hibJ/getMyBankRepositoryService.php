 ...
 */
class getMyBankRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MyBankRepository' shared autowired service.
     *
     * @return \App\Repository\MyBankRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MyBankRepository.php';

        return $container->privates['App\\Repository\\MyBankRepository'] = new \App\Repository\MyBankRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
