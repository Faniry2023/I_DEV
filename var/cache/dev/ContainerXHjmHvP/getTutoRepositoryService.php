 ...
 */
class getTutoRepositoryService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TutoRepository.php';

        return $container->privates['App\\Repository\\TutoRepository'] = new \App\Repository\TutoRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
