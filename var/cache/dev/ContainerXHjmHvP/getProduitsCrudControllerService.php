...
class getProduitsCrudControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Controller'.\DIRECTORY_SEPARATOR.'Admin'.\DIRECTORY_SEPARATOR.'ProduitsCrudController.php';

        $container->services['App\\Controller\\Admin\\ProduitsCrudController'] = $instance = new \App\Controller\Admin\ProduitsCrudController();

        $instance->setContainer(($container->privates['.service_locator.Eo_vzMs'] ?? $container->load('get_ServiceLocator_EoVzMsService'))->withContext('App\\Controller\\Admin\\ProduitsCrudController', $container));
