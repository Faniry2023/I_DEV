 ...
 */
class getCliUserRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CliUserRepository' shared autowired service.
     *
     * @return \App\Repository\CliUserRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CliUserRepository.php';

        return $container->privates['App\\Repository\\CliUserRepository'] = new \App\Repository\CliUserRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
